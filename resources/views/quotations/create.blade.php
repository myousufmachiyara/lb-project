            ...
            <div class="card-body" style="max-height: 500px; overflow-y: auto">
              <table class="table table-bordered" id="quotationDetailsTable">
                ...
                <tbody id="quotationDetailsBody">
                  <tr>
                    <td><input type="file" name="details[0][image]" class="form-control"></td>
                    <td>
                      <select class="form-control select2-js" name="details[0][service_id]" required>
                    ...
                    <td><input type="number" step="0.01" name="details[0][service_charges_per_pc]" class="form-control price-input" readonly></td>
                    <td><input type="text" name="details[0][description]" class="form-control"></td>
                    <td><input type="number" name="details[0][quantity]" class="form-control quantity-input" required></td>
                    <td><input type="text" name="details[0][unit]" class="form-control" required></td>
                    <td><input type="number" step="0.01" name="details[0][cost]" class="form-control cost-input" required></td>
...
<script>
  ...
  // Update price field when service is selected
